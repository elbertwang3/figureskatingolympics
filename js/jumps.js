...
function ready(error,mens, womens) {
	...
	for (var i = 0; i < mens.length; i++) {
		...
		skaterimages.selectAll(".skaterimages")
			...
			.data(['images/skaters/' + skatername.split(" ")[0].toLowerCase() + "sp.png?xxx=987878787",'images/skaters/' + skatername.split(" ")[0].toLowerCase() + "fs.png?xxx=987878787"])
			.enter()
			.append("img")
	...
	for (var i = 0; i < womens.length; i++) {
		...
		skaterimages.selectAll(".skaterimages")
			...
			.data(['images/skaters/' + skatername.split(" ")[0].toLowerCase() + "sp.png",'images/skaters/' + skatername.split(" ")[0].toLowerCase() + "fs.png"])
			.enter()
			.append("img")
			.attr("class", function(d, i) {
				if (i == 0) {
